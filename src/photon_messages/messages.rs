    ...
    match photon_message {
        photon_decode::Message::Event(photon_decode::EventData{
            ...
            match parameters.get(&252u8) {
                ...
                Some(photon_decode::Value::Short(213)) => PartyInvitation::parse(parameters),
                Some(photon_decode::Value::Short(214)) => PartyJoined::parse(parameters),
                Some(photon_decode::Value::Short(215)) => PartyDisbanded::parse(parameters),
                Some(photon_decode::Value::Short(216)) => PartyPlayerJoined::parse(parameters),
                Some(photon_decode::Value::Short(217)) => PartyChangedOrder::parse(parameters),
                Some(photon_decode::Value::Short(218)) => PartyPlayerLeft::parse(parameters),
                Some(photon_decode::Value::Short(219)) => PartyLeaderChanged::parse(parameters),
                Some(photon_decode::Value::Short(220)) => PartyLootSettingChangedPlayer::parse(parameters),
                Some(photon_decode::Value::Short(221)) => PartySilverGained::parse(parameters),
                Some(photon_decode::Value::Short(222)) => PartyPlayerUpdated::parse(parameters),
                Some(photon_decode::Value::Short(223)) => PartyInvitationPlayerBusy::parse(parameters),
                Some(photon_decode::Value::Short(224)) => PartyMarkedObjectsUpdated::parse(parameters),
                Some(photon_decode::Value::Short(225)) => PartyOnClusterPartyJoined::parse(parameters),
                Some(photon_decode::Value::Short(226)) => PartySetRoleFlag::parse(parameters),
